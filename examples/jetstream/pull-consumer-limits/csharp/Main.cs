...
// These default options will be reused when we update the consumer to show-case various limits.
// If you haven't seen the first [pull consumer][1] example yet, check that out first!
...
// One quick note.
// This example showcases how consumer configuration
...
// This limit becomes more visible with the second fetch which would
// time out without any messages since we haven't acked the previous one yet.
...
// have to distribute to a given consumer.
...
// ### Max fetch timeout
// Normally each fetch call can specify its own max wait timeout, i.e.,
