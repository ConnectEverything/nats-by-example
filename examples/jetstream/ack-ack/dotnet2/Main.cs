...
{
    // An exception here means the stream did not exist.
}

// Create the stream
var streamConfig = new StreamConfig(stream, new[] { subject })
{
...
// The second consumer will Ack with the DoubleAck option which confirms that ack was handled.
